...
| Требование / замечание | Статус |
|---|---:|
| Явное разделение зимнего и летнего режима | ✅ |
| Выбор режима в GUI | ✅ |
| Поддержка режима в API | ✅ |
| Отображение примененного режима в результатах | ✅ |
| Учет режима в теплоотводящей способности и собственных нуждах | ✅ |
